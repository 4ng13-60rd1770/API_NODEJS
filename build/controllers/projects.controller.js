...
var createProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var _req$body, name, description, newProject, projectSaved;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newProject = new _Projects["default"]({
              name: name,
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _Projects["default"].findById(req.params.projectId);
...
var updateProjectById = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _Projects["default"].findByIdAndUpdate(req.params.projectId, req.body, {
              "new": true
            });

          case 2:
            updateProject = _context4.sent;
  ...
  return function updateProjectById(_x7, _x8) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return _Projects["default"].findByIdAndDelete(projectId);
